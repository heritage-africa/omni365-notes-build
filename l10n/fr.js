OC.L10N.register(
    ...
    "The Notes app is a distraction free notes taking app for [Omni](https://www.accel-tech.net/). It provides categories for better organization and supports formatting using [Markdown](https://en.wikipedia.org/wiki/Markdown) syntax. Notes are saved as files in your Omni, so you can view and edit them with every Omni client. Furthermore, a separate [REST API](https://www.accel-tech.net/) allows for an easy integration into apps ([Android](https://www.accel-tech.net/), [iOS](https://www.accel-tech.net/), as well as [3rd-party apps](https://www.accel-tech.net/) which allow convenient access to your Omni notes). Further features include marking notes as favorites." : "L'application Notes est une application de prise de notes qui va à l'essentiel pour [Omni](https://www.accel-tech.net/). Elle propose des catégories pour une meilleure organisation et supporte le formatage en syntaxe [Markdown](https://en.wikipedia.org/wiki/Markdown). Les notes sont sauvegardées en tant que fichiers dans votre Omni, donc vous pouvez les voir et les modifier avec n'importe quel client Omni. De plus, une [API REST](https://www.accel-tech.net/)  séparée permet une intégration facile dans les applications ([Android](https://www.accel-tech.net/), [iOS](https://www.accel-tech.net/), ainsi que des [applications tierces](https://www.accel-tech.net/) qui permettent un accès pratique à vos notes Omni). D'autres fonctionnalités incluent le marquage comme favoris.",
    ...
    "Please see Omni server log for details." : "Veuillez consulter les logs du serveur Omni pour plus de détails.",
    "Custom" : "Personnalisé",
